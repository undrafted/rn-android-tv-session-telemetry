...
pub use detector::{
    ...
    HIGH_LATENCY_FOCUS_CHANGE_DETECTOR, HIGH_LATENCY_VISIBLE_UPDATE_DETECTOR,
    JS_STALL_DURING_INTERACTION_DETECTOR, NETWORK_COMPLETION_FOLLOWED_BY_COMMIT_DETECTOR,
