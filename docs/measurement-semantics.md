...
| Topic               | Behavior                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Clocks              | Monotonic only: `performance.now()` in JS, Android's native clock for frame timing. `ClockSyncEvent.wallClockUnixMs` maps workstation bookmarks onto the session timeline.                                                                                                                                                                                                              |
